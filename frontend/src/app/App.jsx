    ...
    <div className="min-h-screen bg-slate-900 text-white flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-slate-800 rounded-xl p-8 shadow-lg border border-slate-700 text-center">
        ...
        <p className="text-slate-400 mb-6">
          โครงสร้างโปรเจกต์ React + Vite + Tailwind CSS พร้อมสำหรับการเขียน UI และฟังก์ชันต่างๆ
        </p>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-xs text-slate-500 mt-4">
            Edit <code className="text-amber-300">src/App.jsx</code> to start building your UI
          </div>
        </div>
      </div>
    </div>
